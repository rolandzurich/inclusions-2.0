...
# All-in-One Datenbank-Setup Script
# Führt Installation, DB-Erstellung und Migrationen in einem Schritt aus
# Führe aus: ssh incluzone@10.55.55.155 "bash -s" < setup-db-all-in-one.sh

set -e

echo "🚀 All-in-One Datenbank-Setup..."
echo ""
...
# 3. Erstelle Schema direkt (ohne externe Dateien)
echo ""
echo "📋 Schritt 3: Erstelle Datenbank-Schema..."

sudo -u postgres psql -d inclusions_db << 'EOF'
