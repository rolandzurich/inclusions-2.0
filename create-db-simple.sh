#!/bin/bash
# Einfaches Skript zum Erstellen der Datenbank
# Führe direkt auf dem Server aus

# Erstelle SQL-Datei mit allen Befehlen
cat > /tmp/setup_db_complete.sql << 'SQL'
...
echo "✅ SQL-Datei erstellt: /tmp/setup_db_complete.sql"
echo ""
echo "Führe aus auf dem Server:"
echo "1. sudo -u postgres psql -d inclusions_db -f /tmp/setup_db_complete.sql"
